...
const catalogoProductos = [
  // CREMAS SKALA
  { id: 1, nombre: "Skala Babosa Brasil", precio: 18.50, categoria: "Cremas Skala", descripcion: "Tratamiento Skala Babosa", tipo: "imagen", archivo: "assets/skala-babosa-brasil.png" },
  { id: 2, nombre: "Skala Tratamiento Mais Cachos", precio: 18.50, categoria: "Cremas Skala", descripcion: "Tratamiento Mais Cachos", tipo: "imagen", archivo: "assets/skala-de-Tratamiento-Mais-Cachos.png" },
  { id: 3, nombre: "Skala Divino Potão", precio: 18.50, categoria: "Cremas Skala", descripcion: "Skala Divino Potão", tipo: "imagen", archivo: "assets/skala-divino-potao.webp" },
  { id: 4, nombre: "Skala Mais Crespos", precio: 18.50, categoria: "Cremas Skala", descripcion: "Skala Mais Crespos", tipo: "imagen", archivo: "assets/skala-mias-crespos.webp" },
  { id: 5, nombre: "Skala Mais Risos", precio: 18.50, categoria: "Cremas Skala", descripcion: "Skala Mais Risos", tipo: "imagen", archivo: "assets/skala-mias-risos.jfif" },
  ...
  { id: 7, nombre: "Aceite de Argán", precio: 7.00, categoria: "Cuidado Capilar", descripcion: "Aceite de Argán", tipo: "imagen", archivo: "assets/aceite-argan.jpg" },
  { id: 8, nombre: "Black Hair Shampoo", precio: 12.00, categoria: "Cuidado Capilar", descripcion: "Black Hair Shampoo", tipo: "imagen", archivo: "assets/black-hair-shampoo.jpg" },
  { id: 9, nombre: "Crema para Peinar Coco Capibbell", precio: 14.00, categoria: "Cuidado Capilar", descripcion: "Crema para Peinar con Coco", tipo: "imagen", archivo: "assets/crema-peinar-coco-capibbell.jpg" },
  { id: 10, nombre: "Crema Tratamiento Capilar Miel", precio: 15.00, categoria: "Cuidado Capilar", descripcion: "Tratamiento Nutritivo con Miel", tipo: "imagen", archivo: "assets/crema-peinar-tratamientoCapilarNutritivoMiel.jpg" },
  { id: 11, nombre: "Leche pal Pelo Rizos (Sachet)", precio: 2.25, categoria: "Cuidado Capilar", descripcion: "Sachet para Rizos", tipo: "imagen", archivo: "assets/leche-pal-pelo-rizos-sachet.webp" },
  { id: 12, nombre: "Leche pal Pelo Tradicional (Sachet)", precio: 2.25, categoria: "Cuidado Capilar", descripcion: "Sachet Tradicional", tipo: "imagen", archivo: "assets/leche-pal-pelo-tradicional-sachet.webp" },
  { id: 13, nombre: "Serum Anti Hair Loss", precio: 7.00, categoria: "Cuidado Capilar", descripcion: "Serum anticaída", tipo: "imagen", archivo: "assets/serum-anit-hair-loss.jpg" },
  ...
  { id: 15, nombre: "Shampoo de Cebolla Willice", precio: 17.75, categoria: "Cuidado Capilar", descripcion: "Shampoo de Cebolla", tipo: "imagen", archivo: "assets/shampoo-cebolla-willice.jpg" },
  { id: 16, nombre: "Shampoo Shumukh de Ajo", precio: 13.00, categoria: "Cuidado Capilar", descripcion: "Shampoo de Ajo", tipo: "imagen", archivo: "assets/shampoo-shumukh-de-ajo.jpg" },
  { id: 17, nombre: "Shampoo Leche pal Pelo Nutrición", precio: 10.00, categoria: "Cuidado Capilar", descripcion: "Shampoo Nutrición", tipo: "imagen", archivo: "assets/shampoo.-leche-pal-pelo-nutricion.png" },
  { id: 18, nombre: "Shampoo Leche pal Pelo Rizos", precio: 10.00, categoria: "Cuidado Capilar", descripcion: "Shampoo para Rizos", tipo: "imagen", archivo: "assets/shampoo.-leche-pal-pelo-rizos.png" },

  // MASCARILLAS FACIALES / OTROS
  { id: 19, nombre: "Crema de Leche Love Jojo 500ml", precio: 10.50, categoria: "Mascarillas Faciales", descripcion: "Crema hidratante 500ml", tipo: "video", archivo: "assets/Crema-De-Leche-500ml-Love-Jojo.mp4" },

  // PERFUMERÍA
  { id: 20, nombre: "Perfume Lovely Dreams", precio: 15.00, categoria: "Perfumería", descripcion: "Lovely Dreams", tipo: "imagen", archivo: "assets/Perfume-Lovely-Dreams.jfif" },
  ...
  { id: 22, nombre: "Perfume Lattafa Yara Eau", precio: 30.00, categoria: "Perfumería", descripcion: "Lattafa Yara", tipo: "imagen", archivo: "assets/perfume-Lattafa-Perfumes-Yara-Eau.webp" },
  { id: 23, nombre: "Perfume Mayar de Lattafa 100ml", precio: 40.00, categoria: "Perfumería", descripcion: "Mayar de Lattafa", tipo: "video", archivo: "assets/perfume-MAYAR-DE-LATTAFA-100MLperfume-MAYAR-DE-LATTAFA-100ML.mp4" },
  { id: 24, nombre: "Perfume Fair Annoy", precio: 10.00, categoria: "Perfumería", descripcion: "Fair Annoy", tipo: "imagen", archivo: "assets/perfume-fairAnnoy.jpg" },
  { id: 25, nombre: "Perfume Futuristic Girl Pink", precio: 10.00, categoria: "Perfumería", descripcion: "Futuristic Girl Pink", tipo: "imagen", archivo: "assets/perfume-fururistic-girl-pink.jpg" },
  { id: 26, nombre: "Perfume Lattafa Asad Decants", precio: 20.00, categoria: "Perfumería", descripcion: "Lattafa Asad Decants", tipo: "imagen", archivo: "assets/perfume-lattafa-asad-decants.jpg" },
  { id: 27, nombre: "Perfume Lattafa Eclaire EDP 100ml", precio: 25.00, categoria: "Perfumería", descripcion: "Lattafa Eclaire", tipo: "imagen", archivo: "assets/perfume-lattafa-eclaire-eau-de-parfum-100ml.jpg" },
  { id: 28, nombre: "Perfume Odyssey Mandarin Sky Elixir", precio: 22.00, categoria: "Perfumería", descripcion: "Mandarin Sky Elixir", tipo: "video", archivo: "assets/perfume-odyssey-mandarin-sky-elixir.mp4" },
  ...
  { id: 30, nombre: "Perfume Splash", precio: 8.00, categoria: "Perfumería", descripcion: "Splash corporal", tipo: "imagen", archivo: "assets/perfume-splash.jpg" },
  { id: 31, nombre: "Perfume Spray Ariana Grande Cloud", precio: 12.00, categoria: "Perfumería", descripcion: "Ariana Grande Cloud", tipo: "imagen", archivo: "assets/perfume-spray-ArianaGrandeCloud.jpg" },
  { id: 32, nombre: "Perfume Spray Jean Paul Gaultier", precio: 12.00, categoria: "Perfumería", descripcion: "Jean Paul Gaultier", tipo: "imagen", archivo: "assets/perfume-spray-JeanPaulGaultier.jpg" },
  { id: 33, nombre: "Perfume Spray Mandarin Sky", precio: 12.00, categoria: "Perfumería", descripcion: "Mandarin Sky", tipo: "imagen", archivo: "assets/perfume-spray-MandarinSky.jpg" },
  { id: 34, nombre: "Perfume Spray Asad Bourbon", precio: 12.00, categoria: "Perfumería", descripcion: "Asad Bourbon", tipo: "imagen", archivo: "assets/perfume-spray-asadBourbon.jpg" },
  { id: 35, nombre: "Perfume Spray Eclaire", precio: 12.00, categoria: "Perfumería", descripcion: "Spray Eclaire", tipo: "imagen", archivo: "assets/perfume-spray-eclaire.jpg" },
  { id: 36, nombre: "Perfume Spray Ice Cream", precio: 12.00, categoria: "Perfumería", descripcion: "Spray Ice Cream", tipo: "imagen", archivo: "assets/perfume-spray-icecream.jpg" },
  { id: 37, nombre: "Perfume Spray Khamrah", precio: 12.00, categoria: "Perfumería", descripcion: "Spray Khamrah", tipo: "imagen", archivo: "assets/perfume-spray-khamrah.jpg" },
  { id: 38, nombre: "Perfume Khamrah Lattafa", precio: 12.00, categoria: "Perfumería", descripcion: "Khamrah Lattafa", tipo: "imagen", archivo: "assets/perfume-khamrahLattafa.jpg" },
  { id: 39, nombre: "Perfume Spray Mayar", precio: 12.00, categoria: "Perfumería", descripcion: "Spray Mayar", tipo: "imagen", archivo: "assets/perfume-spray-mayar.jpg" },
  ...
  { id: 41, nombre: "Perfume Spray Spectra", precio: 12.00, categoria: "Perfumería", descripcion: "Spray Spectra", tipo: "imagen", archivo: "assets/perfume-spray-spectra.jpg" },
  { id: 42, nombre: "Perfume Spray Yara Lattafa Rojo", precio: 112.00, categoria: "Perfumería", descripcion: "Yara Lattafa Rojo", tipo: "imagen", archivo: "assets/perfume-spray-yara-lattafa-rojo.jpg" },
  { id: 43, nombre: "Perfume Spray Yara Lattafa", precio: 12.00, categoria: "Perfumería", descripcion: "Yara Lattafa", tipo: "imagen", archivo: "assets/perfume-spray-yaraLattafa.jpg" },
  { id: 44, nombre: "Perfume Yara Moi", precio: 12.00, categoria: "Perfumería", descripcion: "Yara Moi", tipo: "video", archivo: "assets/perfume-yara-moi.mp4" },
  { id: 45, nombre: "Perfume Yara Tous", precio: 12.00, categoria: "Perfumería", descripcion: "Yara Tous", tipo: "video", archivo: "assets/perfume-yara-tous.mp4" },
  { id: 46, nombre: "Perfumes Futuristic Girl", precio: 8.00, categoria: "Perfumería", descripcion: "Futuristic Girl", tipo: "imagen", archivo: "assets/perfumes-FuturisticGirl.jpg" },
  { id: 47, nombre: "Perfumes de Mujer", precio: 10.00, categoria: "Perfumería", descripcion: "Perfumes de mujer", tipo: "imagen", archivo: "assets/perfumes-de-mujer.jpg" },
  { id: 48, nombre: "Perfumes Hombres", precio: 10.00, categoria: "Perfumería", descripcion: "Perfumes de hombre", tipo: "imagen", archivo: "assets/perfumes-hombres.jpg" }
];
